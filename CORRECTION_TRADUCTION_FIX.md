...
**Symptôme**: `countKeywords()` utilisait `strings.Contains()` qui matchait des sous-chaînes (ex: "a" matchait dans "away", "the" dans "then")
...
- ✅ Verbes courants (make/have/be → faire/avoir/être)
- ✅ Adjectifs scientifiques (combustion/experiment → combustion/expérience)
- ⚠️ Mots rares toujours en EN (chymical, fulhame, etc.)
