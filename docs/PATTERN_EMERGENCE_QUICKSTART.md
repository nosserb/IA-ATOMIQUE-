...
**Result:** 
- Starts with 512à512 gray pixels
...
|-----------|---------|--------|
| **Width/Height** | 512à512 | Output resolution |
...
| **Alpha (à)** | 0.15 | Neighbor influence (0.05-0.3) |
...
Seed Points: ~40,000 pixels (15% of 512²)
Iterations: 200
Time: ~30 seconds
