...
**Resultats Actuels:**
-  **Generation Ultra:** 15ms (128�128)
-  **Generation Draft:** 20ms (256�256)
-  **Generation Fast:** 20ms (256�256)
...
```go
// Au lieu de:
resonance := exp(-(diff^2)/(2�^2))  // Expensive
...
```
Standard: (512�8) � (512�8) = 64^2 = 4,096 atoms
DRAFT:    (256�32) � (256�32) = 8^2 = 64 atoms (64� reduction!)
ULTRA:    (128�64) � (128�64) = 2^2 = 4 atoms (1,024� reduction!)
```
