...
### Avant Phase 13+++
```
• Exemple: "...donné que les systèmes donnent résultats..."
           "...dans ce cas, plusieurs cas différents..."
           "...le monde du digital, un monde qui change..."
• Problème: Répétitions évidentes de "donné/donnent", "cas", "monde"
```

### Après Phase 13+++
```
• Exemple: "...donné que les systèmes fournissent résultats..."
...
### Layer 3: Fenêtrage Strict (Block-selection)
```
Bloc_A vocab: {intell, artif, système}
Bloc_B vocab: {intell, artif, distribué}
     → Similarité: 2/4 = 50% < 60% ✅ OK

Bloc_C vocab: {artif, système, exact}
Bloc_D vocab: {artif, système, timing}
     → Similarité: 2/4 = 50% < 60% ✅ OK
...
Raison: Fenêtrage strict réduit blocs à traiter
...
├─ Ligne 730-745: Fenêtrage strict implémenté
...
### Integration Testing
- [x] ✅ Phase 13+++ s'intègre avec Decouper()
- [x] ✅ Fenêtrage strict compatible sélection
...
1. **Cascade de Filtres Efficace**
   ...
   - Chaque filtre opère indépendamment (modularité)
   - Ordre importe peu (non-dépendances)

2. **Fenêtrage Strict Powerful**
...
4. **Synonymes Discrets**
   ...
   - Dictionnaire peut être domaine-spécifique
...
1. **Étendue Synonymes**: 20 → 50+ entrées
2. **Contexte Sémantique**: Synonymes varient par catégorie (TECH vs SANTÉ)
3. **Bigrammes**: Vérifier couples de mots aussi
4. **Lemmatisation**: "donné/donnent/donnée" = même racine
...
✓ Éliminer répétitions résiduelles  
