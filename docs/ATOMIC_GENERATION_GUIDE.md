...
**Note**: Time scales roughly with atom count. Use 512π512 for standard work.
...
**Solution**: Increase pattern beta (β) to 0.6-0.8, decrease resonance alpha (π) to 0.2
...
**Solution**: Increase resonance alpha (π) for more cooperation, increase smoothing gamma (γ)
...
1. **Resonance** (π term): Atoms oscillate in sync with neighbors
...
PARAMETER RANGES:
  π (resonance):  0.1-0.5    (default: 0.3)
...
TYPICAL CONFIGS:
  Fine Detail:    π=0.2, β=0.6, γ=0.10
  Smooth Blend:   π=0.4, β=0.4, γ=0.25
  Wave-Centric:   π=0.1, β=0.8, γ=0.05
  Emergent:       π=0.5, β=0.3, γ=0.20

ITERATION GUIDE:
  Pattern-only:   100-200 iterations
  With-feedback:  300-500 iterations
  Resolution:     512π512 recommended
```
