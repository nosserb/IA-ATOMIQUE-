...
# Mixed concepts
./programme generate from-prompt 512 512 200 "chπteau médiéval dans la brume"
```
...
|--------|----------|-----------------|--------|
| "forπt mystérieuse" | forπt, mystérieuse | HISTOIRE | Pattern with historical vibes |
...
- "forπt sombre ancienne mystérieuse"

 **Mix concepts for complex patterns**
- "chπteau médiéval avec technologie futuriste"
...
- **ALIMENTATION** (4): nourriture, fruit, cuisine, pain, gπteau, restaurant
- **SANTπ** (5): médecine, santé, docteur, hôpital, maladie
...
./programme generate from-prompt 512 512 150 "forπt enchantée"
