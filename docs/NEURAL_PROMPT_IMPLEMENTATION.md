...
```bash
./programme generate from-prompt 256 256 100 "une for�t mysterieuse avec des arbres luminescents"
```
**Results**:
- Keywords extracted: [for�t, arbres, mysterieuse, luminescents]
- Confidence: 100%
...
| SANT� | 5 | medecine, sante, hopital, docteur |
...
### Mixed Concepts
```bash
./programme generate from-prompt 512 512 200 "ch�teau medieval avec technologie futuriste"
...
// Tokenize
tokens := []string{"for�t", "mysterieuse", "arbres", "luminescents"}
...
# Long description
./programme generate from-prompt 512 512 200 "un ch�teau medieval abandonne dans la brume avec des tours ecroulees et des lumi�res mysterieuses"
